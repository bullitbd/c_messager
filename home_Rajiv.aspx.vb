...
Partial Class home_Rajiv
    ...
    Protected Sub btnRemoveCategory_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRemoveCategory.Click
        ...
        End Try
    End Sub
    Private Sub PopulateCategoryUsers()
        'Try
        '    Dim Group_IDs As String = ""
        '    Group_IDs = GetListBoxContent(ListCategoryNew)
        ...
        '    If Group_IDs <> "" Then
        '        sSQL = GetCategorySQL(Group_IDs)
        '        Call PopulateCategoryListBox(ListUsersNew, sSQL)
        '    End If
        '    If Group_IDs = "" Then
        '        Call RemoveItems(ListUsersNew)
        '    End If
