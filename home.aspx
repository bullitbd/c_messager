<%@ Page Language="VB" AutoEventWireup="false" CodeFile="home.aspx.vb" Inherits="home" ValidateRequest="false" %>
 ...
 <script language="javascript" type="text/javascript">
    ...
    <form id="form1" runat="server">
        <ajaxToolkit:ToolkitScriptManager runat="Server" EnablePartialRendering="true" ID="ScriptManager1" />
                ...
                <div style="border: solid 1px green; width: 1000px; height: 775px; background-color: #FFFBD6; margin: 0 auto;">
                <div>
...
<%--                                    <custom:MsgEditor runat="server" Id="Editor"  Height="200px" 
                                ...
                                <EditPanel InitialCleanUp="True" OnClientLoaded="" DesignPanelCssPath="~/App_Obout/HTMLEditor/CSS/EditorFontOverrides.css">
                                </EditPanel>
                             ...
                             <tr>
                                <td colspan="3">
                                    <table>
                                        <tr valign="top">
                                            <td><span style="font-weight: bold;">FLOATBOX CODE:</span></td>
                                        </tr>
                                        <tr valign="top">
                                            <td>
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox ID="txtMedia" runat="server" BorderWidth="1" Width="375px" 
