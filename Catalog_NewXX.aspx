<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalog_NewXX.aspx.vb" Inherits="Catalog_New"
...
<body>
    ...
    <br class="clearfix" />
    <asp:Panel ID="pnlMain" runat="server" Style="margin-right: 0px" Height="1156px">
        <div class="outerbox">
                ...
                <table border="0" style="width: 580px">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:TextBox ID="txtThumbURL" Width="574px" runat="server" CssClass="box" Height="20px"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </div>
                            ...
                            <table style="border: 0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <%--<span class="smalltext" style="margin-left: 175px">Group
                                            Name</span>--%>
                                        <asp:TextBox ID="txtLinkText" runat="server" CssClass="box floatleft" Height="22px"
                                ...
                                <tr>
                                    <td class="groupcenterbox">
                                        ...
                                        <asp:TextBox ID="txtAlt" Width="345px" runat="server" CssClass="box" Height="24px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="groupcenterbox">
