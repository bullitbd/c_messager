<%@ Page Language="VB" AutoEventWireup="false" CodeFile="homeBD2.aspx.vb" Inherits="home"
...
<head id="Head1" runat="server">
    ...
    <script type="text/JavaScript">
        // this function will be called on EditPanel 'loaded' event fired
        function editPanelLoaded(sender, args) {
            ...
            var designPanelObject = sender.get_modePanels()[designMode];
            // set the capture method
            designPanelObject.captureInDesign = function(ev) {
                // If 'Enter' was pressed 
                if (ev.type == "keydown" && ev.keyCode == Sys.UI.Key.enter && !ev.altKey) {
                    // for undo/redo
                    //this._saveContent();
                    // insert the HTML code
                    //this.insertHTML(ev.ctrlKey ? "<br />" : "<p>");
                    this.insertHTML("</p><p>")
...
<body>
    ...
    <div style="border: solid 1px green; width: 1000px; height: 740px; background-color: #FFFBD6;
        margin: 0 auto;">
        <div>
        ...
        <div style="padding: 10px 1px 1px 1px; float: right; margin-right:10px;">
            <div style="padding: 5px 1px 5px 5px; background-color: #990000; font-weight: bold;
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="3">
                            ...
                            <obout:Editor ID="Editor" runat="server" Height="250px" Width="100%" 
                                ShowQuickFormatting="True">
                                
                                <QuickFormatting Width="75px" />
                                <EditPanel InitialCleanUp="True" OnClientLoaded="editPanelLoaded" DesignPanelCssPath="~/App_Obout/HTMLEditor/CSS/EditorFontOverrides.css">
                                </EditPanel>
                    ...
                    <tr>
                        <td colspan="3">
                            <table>
                                <tr valign="top">
                                    <td>
                                        <span style="font-weight: bold;">Media Text:</span>
                                    </td>
                                </tr>
                                <tr valign="top">
                                    <td>
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtMedia" runat="server" BorderWidth="1" Width="300px" TextMode="MultiLine"
                                                        Rows="4"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:Button ID="btnPreview" runat="server" Text="Preview" OnClientClick="return SendMails1();" />
                                                    <asp:Button ID="btnClear" runat="server" Text="Clear Content" />
                                                    <asp:Button ID="btnSaveDraft" runat="server" Text="Save Draft" />
                                                    <asp:Button ID="btnSend" runat="server" Text="Send" OnClientClick="return SendMails();" /><br />
                                                </td>
                                            </tr>
