<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Copy_of_Catalog_JG.aspx.vb" Inherits="Copy_of_Catalog_JG"  ValidateRequest="false"%>
...
<body>
    ...
    <asp:Panel ID="pnlMain" runat="server" Style="height: 615px;" class="panelDiv">
         <table width="100%">
            <tr>
                <td align="center">
    ...
    <span class="panelTitle">Concierge Catalog - Add Media</span>
                ...
                <tr>
                    ...
                    <td>
                        <cc1:OboutTextBox ID="txtOwnerType" runat="server" FolderStyle="css/oboutSuite/Interface/styles/plain/OboutTextBox"
                            Width="80px" Text="SPONSOR"></cc1:OboutTextBox>
                    </td>
                    <td>
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td style="float:left;">
                        ...
                        <cc1:OboutRadioButton ID="rbnLinkThumb" runat="server" Checked="True" 
                            FolderStyle="css/oboutSuite/Interface/styles/plain/OboutRadioButton" 
                            GroupName="rbgLinkStyle" Text="Thumb">
                        </cc1:OboutRadioButton>&nbsp;&nbsp;&nbsp;
                        <cc1:OboutRadioButton ID="rbnLinkButton" runat="server" 
                            FolderStyle="css/oboutSuite/Interface/styles/plain/OboutRadioButton" 
                            GroupName="rbgLinkStyle" Text="Button">
                        </cc1:OboutRadioButton>&nbsp;&nbsp;&nbsp;
                        <cc1:OboutRadioButton ID="rbnLinkText" runat="server" 
                            FolderStyle="css/oboutSuite/Interface/styles/plain/OboutRadioButton" 
                ...
                <tr><td colspan="2">
                    <cc2:ComboBox ID="cboLinkInfo" runat="server" FolderStyle="css/oboutSuite/ComboBox/styles/plain" Width="90%">
                    </cc2:ComboBox>
                </td></tr>
            </table>
        </div>
                ...
                <tr>
                    <td>
                        <cc1:OboutTextBox ID="txtTitle" FolderStyle="css/oboutSuite/Interface/styles/plain/OboutTextBox"
                            runat="server" ToolTip="Appears at the Top Center  of the Media Frame."
        ...
        <td width="80%">Embed Code <span class="reqdField">*</span></td>
        <td style="text-align:center">Content Preview</td>
        </tr>
        <tr>
        ...
        <td width="80%">
            ...
            <td style="background:#dddddd;"><asp:Literal ID="litPreview" runat="server"></asp:Literal>
        </td></tr>
            </table>
        </div>
        <div class="bottomButtons">
            ...
            <div class="btnRightGroup">
                <cc1:OboutButton ID="btnSubmit" runat="server" FolderStyle="css/oboutSuite/Interface/styles/plain/OboutButton"
                    Text="SAVE" Width="80px" OnClientClick="return ValidateForm();">
                </cc1:OboutButton></div>
            <div class="btnRightGroup">
