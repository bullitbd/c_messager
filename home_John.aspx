<%@ Page Language="VB" AutoEventWireup="false" CodeFile="home_John.aspx.vb" Inherits="home_John" ValidateRequest="false" %>
 ...
 <script language="javascript" type="text/javascript">
    ...
    <form id="form1" runat="server">
        <ajaxToolkit:ToolkitScriptManager runat="Server" EnablePartialRendering="true" ID="ScriptManager1" />
                ...
                <div style="border: solid 1px green; width: 900px; height: 790px; background-color: #FFFBD6; margin: 0 auto;">
                <div>
                                        ...
                                        <TopToolbar Appearance="Custom">
                                            <AddButtons>
                                                ...
                                                <obout:HorizontalSeparator ID="HorizontalSeparator2" runat="server" />
                                                        ...
                                                        <obout:FixedForeColor ID="FixedForeColorCyan" runat="server" 
                                                            DefaultColor="#00a98d" style="padding:1px;">
